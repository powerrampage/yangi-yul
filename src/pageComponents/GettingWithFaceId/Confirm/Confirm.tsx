...
const Confirm = () => {
  ...
  const confirm = () => {
    ...
    router.push(`/getting-with-faceId/step2`);
  }

  return (
    <div>
      <Head>
        <title>{t("ONLAYN ELEKTRON KALIT OLISHNI TASDIQLASH")} ({t("FACE ID orqali olish")})</title>
        <meta name="description" content="ONLAYN ELEKTRON KALIT OLISHNI TASDIQLASH" />
      </Head>
      <HeadComp>
        <div className="size-32 semibold">{t("ONLAYN ELEKTRON KALIT OLISHNI TASDIQLASH")} ({t("FACE ID orqali olish")})</div>
        <div className="mt-10">
