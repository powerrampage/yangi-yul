...
const Physic = () => {
  ...
  const goToNext = () => {
    router.push(`/getting/confirm`);
  }

  return (
    <>
      <Head>
        <title>{t("ERI OLISH UCHUN TO‘LOVNI AMALGA OSHIRING")}</title>
        <meta name="description" content="ERI OLISH UCHUN TO‘LOVNI AMALGA OSHIRING" />
      </Head>
      <HeadComp>
        <div className="size-32 semibold">{t("ERI OLISH UCHUN TO‘LOVNI AMALGA OSHIRING")}</div>
        <div className="mt-10">
